...
var videoPng = /*#__PURE__*/function () {
  function videoPng() {
    _classCallCheck(this, videoPng);
  ...
  _createClass(videoPng, [{
    ...
    key: "videoPngSequence",
    value: function videoPngSequence() {
      console.log("Template method init"); //set transitionBackground dimentions

      var sequenceTimeline = _gsap.default.timeline({});

      _gsap.default.set(this.png, {
        x: "".concat(this.start, "%")
      });
    ...
    key: "setLayerDimensions",
    value: function setLayerDimensions() {
      _gsap.default.set(this.png, {
        width: "".concat(this.videoPng.clientWidth * this.frames, "px"),
        height: "".concat(this.videoPng.clientHeight, "px")
      });
    }
  }]);
...
exports.default = videoPng;

},{"gsap/dist/ScrollTrigger":1,"gsap/dist/gsap":2}],5:[function(require,module,exports){
"use strict";
...
var _VideoPng = _interopRequireDefault(require("./components/VideoPng"));
...
ready(function () {
  ...
  var videoPng = new _VideoPng.default();
  videoPng.init();
});

},{"./components/NavigationController":3,"./components/VideoPng":4,"./helpers/GridHelper":5}]},{},[6])
